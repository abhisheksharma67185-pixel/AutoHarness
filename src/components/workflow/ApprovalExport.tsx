...
export function ApprovalExport({ entries, runId }: ApprovalExportProps) {
  ...
  return (
    <div ref={ref} className="relative inline-block">
      <button
        onClick={() => setOpen((o) => !o)}
        className="flex items-center gap-1 px-2 py-1 text-[10px] font-medium text-gray-500 hover:text-gray-700 bg-white border border-gray-200 rounded hover:border-gray-300 transition-colors"
      >
        <svg
          width="10"
          height="10"
