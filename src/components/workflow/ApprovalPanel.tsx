        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 text-xs font-semibold text-white bg-green-600 rounded py-2 hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-1.5"
            >
              {isExecuting ? (
            ...
            <button
              ...
              disabled={isExecuting}
              className="flex-1 text-xs font-semibold text-white bg-red-500 rounded py-2 hover:bg-red-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-1.5"
            >
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
